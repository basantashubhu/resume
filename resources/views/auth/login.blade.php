...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 d-flex" style="min-height: 78.1vh;">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" class="btn btn-info col-sm-2 col-md-3">
                                    {{ __('Login') }}
                                </button>

                                <a class="text-primary ml-1 hvr-links" href="{{ route('password.request') }}">
